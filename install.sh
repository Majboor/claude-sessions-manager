...
mkdir -p "$HOME/bin"
cp "$REPO/bin/claude-sessions-refresh" "$REPO/bin/claude-restore" "$REPO/bin/claude-respawn" "$REPO/bin/claude-session-edit" "$REPO/bin/claude-restore-handover" "$HOME/bin/"
chmod +x "$HOME/bin/claude-sessions-refresh" "$HOME/bin/claude-restore" "$HOME/bin/claude-respawn" "$HOME/bin/claude-session-edit" "$HOME/bin/claude-restore-handover"
